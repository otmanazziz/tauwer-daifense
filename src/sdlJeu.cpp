...
sdlJeu::sdlJeu () {
    ...
    coin.loadFromFile("coin.png",renderer);
    img_life.loadFromFile("life.png", renderer);
    img_upDamage.loadFromFile("upDamage.png",renderer);
    img_upPortee.loadFromFile("upPortee.png",renderer);
    img_upVitesseAtq.loadFromFile("upVitesseAtq.png",renderer);
